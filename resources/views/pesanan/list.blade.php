...
@section('content')
    <h1 class="h3 mb-2 text-gray-800">Halaman pesanan</h1>
    ...
    <div class="card shadow mb-4 col">
        <div class="card-header py-3 row">
            ...
            <div class="col-6 text-right">
                <a href="{{ route('pesanan.create') }}" class="btn btn-success rounded-pill">
                    Tambah Data +
                </a>
            </div>
        </div>
                        ...
                        @foreach ($pesanans as $pesanan)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="mb-3" action="{{ route('pesanan.delete', $pesanan->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
